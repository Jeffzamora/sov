...
<!-- Modal: Crear Rol -->
<div class="modal fade" id="modal-role-create" tabindex="-1" aria-hidden="true">
...
<!-- Modal: Editar Rol -->
<div class="modal fade" id="modal-role-edit" tabindex="-1" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
    <div class="modal-content">
...
<div class="modal fade" id="modal-role-perms" tabindex="-1" aria-hidden="true">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="alert alert-warning py-2">
          <small>
            Para que sea 100% funcional: endpoints de permisos (listar, ver asignados, guardar asignación).
            Si ya tienes los controladores de permisos, pégamelos y lo conecto completo.
          </small>
        </div>
        <div class="text-muted">Pendiente de integración RBAC UI.</div>
      </div>
      <div class="modal-footer">
