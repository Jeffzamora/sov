...
// Menús padres (dropdown)
$activeMenu['mantenimiento'] = ($activeMenu['reportes'] || $activeMenu['auditoria']);
$activeMenu['operaciones']   = ($activeMenu['cajas'] || $activeMenu['ventas']);
?>
...
<head>
    ...
    <!-- Select2 -->
    <link rel="stylesheet"
        href="<?php echo $URL; ?>/public/templeates/AdminLTE-3.2.0/plugins/select2/css/select2.min.css">
    <link rel="stylesheet"
        href="<?php echo $URL; ?>/public/templeates/AdminLTE-3.2.0/plugins/select2-bootstrap4-theme/select2-bootstrap4.min.css">
    ...
    <!-- DataTables -->
    <link rel="stylesheet"
        href="<?php echo $URL; ?>/public/templeates/AdminLTE-3.2.0/plugins/datatables-bs4/css/dataTables.bootstrap4.min.css">
    <link rel="stylesheet"
        href="<?php echo $URL; ?>/public/templeates/AdminLTE-3.2.0/plugins/datatables-responsive/css/responsive.bootstrap4.min.css">
    <link rel="stylesheet"
        href="<?php echo $URL; ?>/public/templeates/AdminLTE-3.2.0/plugins/datatables-buttons/css/buttons.bootstrap4.min.css">
    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            <a href="<?php echo $URL; ?>/" class="brand-link">
                <img src="<?php echo $URL; ?>/public/images/optica/logo_bajo.png" alt="Óptica"
            ...
            <div class="sidebar">
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    <div class="image">
                        <img src="<?php echo $URL; ?>/public/templeates/AdminLTE-3.2.0/dist/img/user2-160x160.jpg"
                            class="img-circle elevation-2" alt="Usuario">
                    </div>
                    <div class="info">
                        ...
                        <div class="small text-muted" style="margin-top:2px;">
                            <a href="<?php echo $URL; ?>/usuarios/password.php" class="text-muted">Cambiar
                                contraseña</a>
                        </div>
                    </div>
                </div>
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <!-- =======================
                 MANTENIMIENTO (Reportes + Auditoría)
                 ======================= -->
                        <?php
              $canReportes  = function_exists('ui_can') ? ui_can('reportes.ver') : true;
              $canAuditoria = function_exists('ui_can') ? ui_can('auditoria.ver') : true;
            ?>
                        <?php if ($canReportes || $canAuditoria): ?>
                        <li class="nav-item <?php echo $activeMenu['mantenimiento'] ? 'menu-open' : ''; ?>">
                            <a href="#" class="nav-link <?php echo $activeMenu['mantenimiento'] ? 'active' : ''; ?>">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item">
                                    <a href="<?php echo $URL; ?>/reportes"
                                        class="nav-link <?php echo $activeMenu['reportes'] ? 'active' : ''; ?>">
                                ...
                                <?php if ($canAuditoria): ?>
                                <li class="nav-item">
                                    <a href="<?php echo $URL; ?>/auditoria"
                                        class="nav-link <?php echo $activeMenu['auditoria'] ? 'active' : ''; ?>">
                        ...
                        <!-- =======================
                 CAJA Y VENTAS (dropdown)
                 ======================= -->
                        <?php
              $canCaja   = function_exists('ui_can') ? ui_can('cajas.ver') : true;
              $canVentas = function_exists('ui_can') ? ui_can('ventas.ver') : true;
            ?>
                        <?php if ($canCaja || $canVentas): ?>
                        <li class="nav-item <?php echo $activeMenu['operaciones'] ? 'menu-open' : ''; ?>">
                            <a href="#" class="nav-link <?php echo $activeMenu['operaciones'] ? 'active' : ''; ?>">
                                <i class="nav-icon fas fa-cash-register"></i>
                                <p>Caja y Ventas <i class="right fas fa-angle-left"></i></p>
                            </a>
                            <ul class="nav nav-treeview">
                                <?php if ($canCaja): ?>
                                <li class="nav-item">
                                    <a href="<?php echo $URL; ?>/cajas"
                                        class="nav-link <?php echo $activeMenu['cajas'] ? 'active' : ''; ?>">
                                        <i class="nav-icon fas fa-cash-register"></i>
                                ...
                                <li class="nav-item">
                                    <a href="<?php echo $URL; ?>/ventas"
                                        class="nav-link <?php echo $activeMenu['ventas'] ? 'active' : ''; ?>">
